...
name = 'entropy'
MLPPATH = 'logs/{0}/b_{0}_MLP_checkpoint.pt'.format(name)
GCNPATH = 'logs/{0}/b_{0}_GCN_checkpoint.pt'.format(name)
...
def main():  
    ...
    for iteration in range(1,T-1):
        ...
        idx_train, idx_available = node_selection(idx_train, idx_available, score = score, batch_size= batch_size * num_class)
...
def evaluate(hidden_size, features, labels, idx_train, idx_val, idx_test, adj):
    ...
    cm.figure_.savefig('logs/entropy/b_entropy_confusion_matrix.png')
