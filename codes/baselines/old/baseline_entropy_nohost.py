...
name = 'entropynohost'
MLPPATH = 'logs/{}/b_entropy_MLP_checkpoint.pt'.format(name)
GCNPATH = 'logs/{}/b_entropy_GCN_checkpoint.pt'.format(name)
...
def evaluate(hidden_size, features, labels, idx_train, idx_val, idx_test, adj):
    ...
    cm.figure_.savefig('logs/entropynohost/b_entropy_confusion_matrix.png')
