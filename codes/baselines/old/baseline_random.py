...
name = 'random'
MLPPATH = 'logs/random/b_random_MLP_checkpoint.pt'
GCNPATH = 'logs/random/b_random_GCN_checkpoint.pt'
import configparser
...
def main():  
    ...
    pd.DataFrame({"num": idx_train_list, "acc": test_accs}).to_csv("logs/random/data.csv")
...
def evaluate(hidden_size, features, labels, idx_train, idx_val, idx_test, adj):
    ...
    cm.figure_.savefig('logs/random/b_random_confusion_matrix.png')
